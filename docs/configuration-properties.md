...
**spark.sql.pipelines** is a family of the configuration properties ([Spark SQL]({{ book.spark_sql }}/configuration-properties)) for Spark Declarative Pipelines.
...
* `TriggeredGraphExecution` is requested to [backoffStrategy](TriggeredGraphExecution.md#backoffStrategy)
...
* `TriggeredGraphExecution` is requested for the [concurrencyLimit](TriggeredGraphExecution.md#concurrencyLimit) and to [topologicalExecution](TriggeredGraphExecution.md#topologicalExecution)
...
* `GraphExecution` is requested to [stopThread](GraphExecution.md#stopThread)
...
Can be set at the [pipeline](PipelineUpdateContext.md#spark) or [flow](Flow.md#sqlConf) level
...
* `GraphExecution` is requested to [maxRetryAttemptsForFlow](GraphExecution.md#maxRetryAttemptsForFlow)
